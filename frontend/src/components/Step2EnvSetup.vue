    ...
    <div class="scroll-container">
      ...
      <div class="step-card" :class="{ 'active': phase === 0, 'completed': phase > 0 }">
        ...
        <div class="card-content">
          ...
          <p class="description">
            Create a new simulation instance and load the scenario parameter template.
          </p>
      ...
      <div class="step-card" :class="{ 'active': phase === 1, 'completed': phase > 1 }">
        ...
        <div class="card-content">
          ...
          <p class="description">
            Using the scenario context, the system extracts entities and relations from the knowledge graph, initializes simulation actors, and gives them behavior patterns and memory derived from the source material.
          </p>
          ...
          <div v-if="profiles.length > 0" class="stats-grid">
            ...
            <div class="stat-card">
              ...
              <span class="stat-label">Source-Linked Topics</span>
            </div>
          </div>
      ...
      <div class="step-card" :class="{ 'active': phase === 2, 'completed': phase > 2 }">
        <div class="card-header">
          <div class="step-info">
            ...
            <span class="step-title">Build Dual-Platform Config</span>
          </div>
          <div class="step-status">
        ...
        <div class="card-content">
          <p class="api-note">POST /api/simulation/prepare</p>
          <p class="description">
            The LLM turns the simulation brief and source material into time flow, ranking behavior, agent activity windows, posting frequency, and event triggers.
          </p>
              ...
              <div class="platforms-grid">
                <div v-if="simulationConfig.twitter_config" class="platform-card">
                  <div class="platform-card-header">
                    <span class="platform-name">Platform 1: Feed / Plaza</span>
                  </div>
      ...
      <div class="step-card" :class="{ 'active': phase === 3, 'completed': phase > 3 }">
        ...
        <div class="card-content">
          <p class="api-note">POST /api/simulation/prepare</p>
          <p class="description">
            Based on the narrative direction, the system generates initial activation events and hot topics to shape the starting state of the simulation world.
          </p>
      ...
      <div class="step-card" :class="{ 'active': phase === 4 }">
        ...
        <div class="card-content">
          ...
          <p class="description">The simulation environment is ready. You can now start the run.</p>
              ...
              <div v-if="useCustomRounds" class="rounds-content custom" key="custom">
                <div class="slider-display">
                  ...
                  <div class="slider-meta-info">
                    <span>If the agent count is 100: estimated time is about {{ Math.round(customMaxRounds * 0.6) }} minutes</span>
                  </div>
                </div>
                  ...
                  <div class="auto-content">
                    <div class="auto-meta-row">
                      <span class="duration-badge">
                        ...
                        If the agent count is 100: estimated time is {{ Math.round(autoGeneratedRounds * 0.6) }} minutes
                      </span>
                    </div>
                    <div class="auto-desc">
                      <p class="highlight-tip" @click="useCustomRounds = true">For the first run, switch to Custom mode to reduce the round count, get a faster preview, and lower the chance of errors. ➝</p>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div class="modal-section" v-if="selectedProfile.persona">
            ...
            <div class="persona-dimensions">
              <div class="dimension-card">
                ...
                <span class="dim-desc">The full action trail within this scenario</span>
              </div>
              <div class="dimension-card">
                <span class="dim-title">Behavioral Profile</span>
                <span class="dim-desc">Summary of habits and decision style</span>
              </div>
              <div class="dimension-card">
                <span class="dim-title">Memory Imprint</span>
                <span class="dim-desc">Memory formed from the real-world source material</span>
              </div>
              <div class="dimension-card">
  ...
  try {
    ...
    if (res.success && res.data) {
      if (res.data.already_prepared) {
        addLog('Existing preparation found, reusing it.')
...
const pollPrepareStatus = async () => {
  ...
  try {
    ...
    console.warn('Preparation polling failed:', err)
  }
}
  ...
  try {
    ...
    if (res.success && res.data) {
      if (res.data.config_generated && res.data.config) {
        ...
        // 配置尚未生成，开始轮询
        addLog('Config is still generating. Starting the wait loop...')
        startConfigPolling()
      }
    }
  } catch (err) {
