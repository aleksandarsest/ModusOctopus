    ...
    <div class="scroll-container">
      ...
      <div class="step-card" :class="{ 'active': currentPhase === 0, 'completed': currentPhase > 0 }">
        ...
        <div class="card-content">
          ...
          <p class="description">
            The LLM analyzes the source documents and simulation brief, extracts the scenario seed, and generates a suitable ontology structure.
          </p>
      ...
      <div class="step-card" :class="{ 'active': currentPhase === 2, 'completed': currentPhase >= 2 }">
        <div class="card-header">
          <div class="step-info">
            ...
            <span class="step-title">Graph Ready</span>
          </div>
          <div class="step-status">
        ...
        <div class="card-content">
          ...
          <p class="description">The graph build is complete. Move on to simulation environment setup.</p>
          <button 
            class="action-btn" 
