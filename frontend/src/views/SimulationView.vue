  ...
  <div class="main-view">
    ...
    <header class="app-header">
      <div class="header-left">
        <div class="brand" @click="router.push('/')">MODUSOCTOPUS</div>
      </div>
...
const handleNextStep = (params = {}) => {
  ...
  // Pass custom rounds through query params when present
  if (params.maxRounds) {
...
/**
 * Check and close a running simulation
...
const checkAndStopRunningSimulation = async () => {
  ...
  try {
    ...
    if (envStatusRes.success && envStatusRes.data?.env_alive) {
      ...
      // Environment is not running, but the process may still exist
    ...
    // Environment status checks should not block the flow
...
onMounted(async () => {
  ...
  // Check and close any running simulation when coming back from Step 3
