"""
Report API routes.
Provides endpoints for report generation, retrieval, and report chat.
"""
...
def get_generate_status():
    ...
    try:
        ...
        return jsonify({
            "success": False,
            "error": f"Failed to fetch report generation status: {str(e)}"
        }), 500
...
def get_report_by_simulation(simulation_id: str):
    ...
    try:
        ...
        return jsonify({
            "success": False,
            "error": f"Failed to fetch report by simulation: {str(e)}",
            "traceback": traceback.format_exc()
        }), 500
...
def chat_with_report_agent():
    ...
    try:
        ...
        return jsonify({
            "success": False,
            "error": f"Report chat failed: {str(e)}",
            "traceback": traceback.format_exc()
        }), 500
...
def get_report_progress(report_id: str):
    ...
    try:
        ...
        return jsonify({
            "success": False,
            "error": f"Failed to fetch report progress: {str(e)}",
            "traceback": traceback.format_exc()
        }), 500
...
def get_report_sections(report_id: str):
    ...
    try:
        ...
        return jsonify({
            "success": False,
            "error": f"Failed to fetch report sections: {str(e)}",
            "traceback": traceback.format_exc()
        }), 500
...
def get_single_section(report_id: str, section_index: int):
    ...
    try:
        ...
        return jsonify({
            "success": False,
            "error": f"Failed to fetch report section: {str(e)}",
            "traceback": traceback.format_exc()
        }), 500
...
def get_agent_log(report_id: str):
    ...
    try:
        ...
        return jsonify({
            "success": False,
            "error": f"Failed to fetch agent log: {str(e)}",
            "traceback": traceback.format_exc()
        }), 500
...
def stream_agent_log(report_id: str):
    ...
    try:
        ...
        return jsonify({
            "success": False,
            "error": f"Failed to fetch complete agent log: {str(e)}",
            "traceback": traceback.format_exc()
        }), 500
...
def get_console_log(report_id: str):
    ...
    try:
        ...
        return jsonify({
            "success": False,
            "error": f"Failed to fetch console log: {str(e)}",
            "traceback": traceback.format_exc()
        }), 500
...
def stream_console_log(report_id: str):
    ...
    try:
        ...
        return jsonify({
            "success": False,
            "error": f"Failed to fetch complete console log: {str(e)}",
            "traceback": traceback.format_exc()
        }), 500
...
def get_graph_statistics_tool():
    ...
    try:
        ...
        return jsonify({
            "success": False,
            "error": f"Failed to fetch graph statistics: {str(e)}",
            "traceback": traceback.format_exc()
        }), 500
